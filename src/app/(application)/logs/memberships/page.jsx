...
import { MembershipLogsTable } from './components/LogsTable';
...
export default function MembershipLogs() {
	...
	useEffect(() => {
		if (logs) {
			...
			if (selectedBranch) {
				filtered = filtered.filter(plan => plan.branch_id === selectedBranch);
			}
	...
	return (
		<section className='p-10 w-full'>
			...
			<MembershipLogsTable logs={filteredLogs} />
		</section>
	)
};
