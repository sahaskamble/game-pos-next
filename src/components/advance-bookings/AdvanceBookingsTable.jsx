...
const columns = [
  {
    id: "customer",
    accessorFn: (row) => row.expand?.customer_id?.customer_name,
    header: ({ column }) => {
      return (
        <Button
          variant="ghost"
  ...
  },
  {
    ...
    cell: ({ row }) => format(new Date(row.getValue("visiting_time")), "PPpp"),
  },
  {
    id: "no_of_players",
  ...
  {
    id: "branch",
    accessorFn: (row) => row.expand?.branch_id?.name,
    header: "Branch",
  },
  {
    id: "created",
    ...
    cell: ({ row }) => format(new Date(row.getValue("created")), "PPpp"),
  },
];
...
export function AdvanceBookingsTable({ data = [], loading }) {
  ...
  const [selectedColumn, setSelectedColumn] = React.useState("customer");
